...
"Late Mughal Ivory Dagger","Weaponry & Armor","approx. 220 years","Ivory, steel blade","Fair",18000,"Room 3","Room 5","On Display","Handle with custom gloves"
"Embroidered Zardozi Tapestry","Textiles & Carpets","approx. 140/years","Silk filaments, gold threads","Good",35000,"Tiger Room","Living Room","On Display","Keep away from humidity"
"Uchagaon Terracotta Glazed Pot","Ceramics & Pottery","approx. 90 years","Clay, cobalt slip","Poor",4500,"Sun Room","Room 21","On Display","Inspect monthly for cracks"`;
