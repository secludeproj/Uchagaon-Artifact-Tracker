              ...
              <div>
                ...
                {avatarMode === "upload" && (
                  <div className="space-y-2">
                    ...
                    <input ref={cameraInputRef} type="file" accept="image/*" capture="user" className="hidden"
                      onChange={e => e.target.files?.[0] && handleFileUpload(e.target.files[0])} />
                    {photoUrl && <p className="text-[10px] text-emerald-700 font-mono">✓ Photo uploaded</p>}
                    {uploading && <p className="text-[10px] text-[#3b5249] font-mono animate-pulse">Processing...</p>}
                  </div>
                )}
                ...
                {avatarMode === "url" && (
                  <div>
                    ...
                    <p className="text-[9px] text-[#8e847a] mt-1 italic font-serif">Paste a direct link to your photo</p>
                  </div>
                )}
              </div>
